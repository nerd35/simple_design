...
const Footer = () => {
  return (
    <div className="py-5 footer-container text-light">
      <div className="container py-5">
        ...
        <p class=" quick-links">Copyright ©2021 All rights reserved | This template is made with <span className="text-danger"><FaHeart/></span>  by <strong className="text-info">Nerd35</strong></p>
      </div>
    </div>
  );
};
